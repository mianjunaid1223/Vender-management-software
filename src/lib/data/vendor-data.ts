...
import type { Invoice, Contract, Vendor } from '@/lib/types';
import type { EnhancedVendor, VendorUser, ComplianceDocument, DataSyncQueue } from '@/lib/types/vendor-portal';
import { createAuditLog, createDataAccessLog } from '@/lib/audit';
