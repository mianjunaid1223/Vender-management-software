import { AIContext, Company, ActionLog, User, Contract, Vendor, Invoice } from '@/shared/types/types';
import { fetchCompany, fetchRecentActions, fetchContracts, fetchVendors, fetchInvoices, getUser } from '@/shared/lib/data';
