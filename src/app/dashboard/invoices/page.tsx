...
import { InvoiceManagementClient } from "@/features/dashboard/components/invoice-management-client";
import { fetchInvoices, fetchVendors, fetchContracts } from "@/shared/lib/data";
