...
import { Contract, ContractType, ContractStatus, Vendor, Company, ContractParty } from "@/shared/types/types";
import { useToast } from "@/shared/hooks/use-toast";
import { createContract } from "@/shared/lib/data";
...
export function ContractOnboardingDialog({ vendors = [], company = null, onContractAdded }: ContractOnboardingDialogProps = {}) {
