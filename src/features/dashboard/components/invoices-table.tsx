...
import { downloadInvoicePDF, previewInvoicePDF } from "@/core/utils/pdf-utils";
import type { Invoice, Vendor, Contract } from "@/shared/types/types";
...
export function InvoicesTable({ 
  ...
  const handleDuplicateInvoice = (invoice: Invoice) => {
    const { id, invoiceNumber, status, createdAt, updatedAt, ...rest } = invoice as any;
